...
class SeriesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
	...
	let series = ["Breaking Bad", "Game of thrones", "How I met your mother", "Friends", "The Office"]
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		let cell = tableView.dequeueReusableCell(withIdentifier: "SeriesPosterCollectionViewCell")
